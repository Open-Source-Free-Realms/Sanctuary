...
public class TransformAbilityCollection : ObservableConcurrentDictionary<int, TransformAbilityDefinition>
{
    private readonly ILogger _logger;

    public TransformAbilityCollection(ILogger logger)
    {
        _logger = logger;
    }
    ...
    public bool Load(string filePath)
    {
        ...
        try
        {
            ...
            var list = JsonSerializer.Deserialize<List<TransformAbilityDefinition>>(fileStream, jsonSerializerOptions);
