...
public class ClientActivityDefinitionCollection : ObservableConcurrentDictionary<int, ClientActivityDefinition>
{
    private readonly ILogger _logger;

    public ClientActivityDefinitionCollection(ILogger logger)
    {
        _logger = logger;
    }
    ...
    public bool Load(string filePath)
    {
        ...
        try
        {
            ...
            var entries = JsonSerializer.Deserialize<List<ClientActivityDefinition>>(fileStream, jsonSerializerOptions);
